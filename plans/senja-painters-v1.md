...
- **Media storage**: V1 stores real project photos as static assets under `public/` and renders them with `next/image`. No external media bucket, CMS media library, or upload flow is included in V1.
